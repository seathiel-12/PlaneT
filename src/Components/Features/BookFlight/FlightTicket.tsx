        ...
        <div className='rounded-2xl border-[0.5px] border-gray-300 shadow-xs px-4 py-10 flex bg-white justify-around'>
            <div className='flex items-center gap-5 min-w-max'>
                ...
                <div className=''>
                    ...
                    <ClassTravel classTravel={classTravel} />
                </div>
            </div>
...
export const PricePerSeat:React.FC<FlightTicketProps> = (flight)=> {
...
export const ClassTravel:React.FC<{classTravel: string}> = ({classTravel}) => {
    return (
